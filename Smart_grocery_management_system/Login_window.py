...
def hide():
    openeye.config(file="/Users/arpit_lal/Desktop/eye.png")
    password.config(show="/Users/arpit_lal/Desktop/eye-close-up.png")
...
def sign_page():
    ...
    # Ensure this module exists and is correct
...
# Background Image
background = ImageTk.PhotoImage(file="/Users/arpit_lal/Desktop/grocery-shop-management-system-software-1000x1000.jpg")
...
openeye = PhotoImage(file="/Users/arpit_lal/Desktop/eye-close-up.png")
