...
background = ImageTk.PhotoImage(file="/Users/arpit_lal/Desktop/futuristic-square-gradient-background-pop-up-window-illustration-vector.jpg")
...
check = IntVar()
termsandcondition = Checkbutton(frame, text='I agree to terms & conditons', font=('Montserrat', 14, 'bold'),
                                activebackground='gainsboro', activeforeground='RoyalBlue4', cursor='hand2',
                                variable=check, fg="Royalblue4")
termsandcondition.grid(row=11, column=0, sticky='w', padx=2, pady=15)

SignupButton = Button(frame, text="Signup", font=('Open sans', 14, 'bold'), bd=0, fg='Royalblue4',
                      activebackground='RoyalBlue4', activeforeground='white', command=connect_database)
...
createnewbutton = Button(frame, text="Log in", font=('Open Sans', 11, 'bold underline'), activebackground='white',
                         cursor="hand2", activeforeground='blue', bd=0, command=login_page, fg="Royalblue4")
